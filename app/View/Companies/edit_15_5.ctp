                        ...
                        <div class="controls col-md-8 col-md-offset-2">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group"> 
                                    	<?php echo $this->Form->input('company_type',array('required'=>false,'class'=>"form-control",'type'=>"select",'options'=>$company_type,"label"=>false, 'disabled'=>true)); ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('company_name',array('required'=>false,'class'=>"form-control",  'placeholder'=>"Company Name","label"=>false, 'disabled'=>true)); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group"> 
                                        <label class="custom-file">
                                        	<?php echo $this->Form->input('trade_license',array('required'=>false,'type'=>'file',"label"=>false, "accept"=>".pdf, image/*", 'class'=>"custom-file-input")); ?>
                            ...
                            <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group"> 
                                        <label class="custom-file">
                                          <?php echo $this->Form->input('immigration_card',array('required'=>false,'type'=>'file',"label"=>false, "accept"=>".pdf, image/*", 'class'=>"custom-file-input")); ?>
                                          <span class="custom-file-control">Uplaod Immigration Card</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group"> 
                                        <label class="custom-file">
                                          <?php echo $this->Form->input('labour_card',array('required'=>false,'type'=>'file',"label"=>false, "accept"=>".pdf, image/*", 'class'=>"custom-file-input")); ?>
                                          <span class="custom-file-control">Uplaod Labour Card</span>
                                        </label>
                                    </div>
                                </div>
