 <div class="gride-itm row">
        ...
        <div class="div_left col-lg-5">
            <h3 class="breadcrumb">Update application</h3>
        </div>
        </div>
    </div>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo $this->Form->input('country_type',array('required'=>false,'class'=>"form-control",'type'=>"select",'options'=>$country_type,"label"=>false,'disabled'=>true)); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group"> 
                                <label class="custom-file">
                                    ...
                                    <span class="<?php echo $class?>"><span class="glyphicon glyphicon-upload"></span> Health Insurance Copy</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group"> 
                                <label class="custom-file">
                                    ...
                                    <span class="<?php echo $class?>"><span class="glyphicon glyphicon-upload"></span> Emirates Id Copy Front</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group"> 
                                <label class="custom-file">
                                    ...
                                    <span class="<?php echo $class?>"><span class="glyphicon glyphicon-upload"></span> Emirates Id Copy Back</span>
