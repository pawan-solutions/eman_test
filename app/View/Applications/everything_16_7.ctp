        ...
        <div class="process-type">
         <span class="divs<?php echo $app_id?>">
            ...
            <div class="process-button1">
                ...
                <span><a href="javascript:void(0)" app_id="<?php echo $app_id; ?>" class="barcode_print" barcode="<?php echo $value['Application']['barcode']?>"><img src="<?php echo SITE_URL.'img/barcode-icon.png'; ?>" alt="Barcode" height="26"/></a></span>
...
<div id="myModalBarcode" class="modal">
  <div class="modal-content">
    ...
    echo $this->Form->input('barcode',array('type'=>'textarea','id'=>'scanned_barcode', 'class'=>"form-control", 'label'=>false,'maxlength'=>1000));
     echo $this->Form->button('Check Status',array('type'=>'button', 'class'=>'btn btn-primary', 'id'=>'submit_barcode'));
     echo $this->Form->end();
    ?> 
    </div>
...
var modalBarcode = document.getElementById('myModalBarcode');
    ...
    $(".barcode_print").click(function(){
        ...
        $name = 
        var conf = confirm("Do you want to print barcode ["+$barcode+"] of ");
        if(conf==true)
        {
            return false;
        }
                  ...
                  success: function(barcode_res){
                    ...
                    $('#show_barcodes').html(barcode_res);
                         ...
                         $('#final_submit_barcode').bind("click",function(){
                            passport_tracking_submit(values);
                        });    
                  }
                }); 
