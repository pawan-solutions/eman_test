             ...
             <?php echo $this->Form->create('Application', array('class'=>"contact-form",'type'=>'file')); ?>    
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group"> 
                                <label class="custom-file">
                                    <?php echo $this->Form->input('trade_license',array('required'=>false,'type'=>'file',"label"=>false, "accept"=>"image/*", 'onchange'=>"loadFile(this.id)", 'class'=>"custom-file-input")); 
                                    if($this->request->data['ApplicationDetail']['trade_license']!='')
                                    {
                                    $class =  "custom-file-control-green";   
                                    }else{
                                    $class =  "custom-file-control";      
                                    }?>
                                    <span class="<?php echo $class?>"><span class="glyphicon glyphicon-upload"></span> Upload Trade license</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group"> 
                                <label class="custom-file">
                                    <?php echo $this->Form->input('emp_contract',array('required'=>false,'type'=>'file',"label"=>false, "accept"=>"image/*", 'onchange'=>"loadFile(this.id)", 'class'=>"custom-file-input")); 
                                    if($this->request->data['ApplicationDetail']['emp_contract']!='')
                                    {
                                    $class =  "custom-file-control-green";   
                                    }else{
                                    $class =  "custom-file-control";      
                                    }?>
                                    <span class="<?php echo $class?>"><span class="glyphicon glyphicon-upload"></span> Upload Employee's Contract</span>
