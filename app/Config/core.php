 ...
 */
	switch ($_SERVER['HTTP_HOST']) {
      case 'localhost':
        Configure::write('debug',2);    // for production
        break;
      case 'localhost:8080':
        Configure::write('debug',2);   // for production
        break;
      default:
        Configure::write('debug',0);  // for live
 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9midhaseee');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309657453542496749683645902323');
