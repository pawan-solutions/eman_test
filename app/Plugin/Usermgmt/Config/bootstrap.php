...
function UsermgmtInIt(&$controller) {
    ...
    if(!defined("ADMIN_LOGIN_STRING")) {
		define("ADMIN_LOGIN_STRING", ((isset($allSettings['adminLoginString'])) ? $allSettings['adminLoginString']['value'] : 'myadmin'));
	}
    ...
    if(!defined("GOOGLE_APP_ID")) {
		define("GOOGLE_APP_ID", ((isset($allSettings['googleAppId'])) ? $allSettings['googleAppId']['value'] : ''));
	}
	if(!defined("GOOGLE_SECRET")) {
		define("GOOGLE_SECRET", ((isset($allSettings['googleSecret'])) ? $allSettings['googleSecret']['value'] : ''));
	}
